...
namespace ParaWorldStatus.Model
{
    public class PWState
    {
        ...
        static readonly string StateFolder = System.IO.Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData), "SpieleEntwicklungsKombinat/Paraworld/DiscordState/");
        ...
        {
            var fs = new FileStream(System.IO.Path.Combine(StateFolder,StateFile), FileMode.Open, FileAccess.Read, FileShare.ReadWrite);
